                        ...
                        <td>
                            <div class="d-flex justify-content-end">
                                @can('crm_customer_show')
                                    <a class="btn btn-sm btn-info mx-1" href="{{ route('admin.crm-customers.show', $crmCustomer) }}">
                                        {{ trans('global.view') }}
                                    </a>
                                @endcan
                                @can('crm_customer_edit')
                                    <a class="btn btn-sm btn-primary mx-1" href="{{ route('admin.crm-customers.edit', $crmCustomer) }}">
                                        {{ trans('global.edit') }}
                                    </a>
                                @endcan
                                @can('crm_customer_delete')
                                    <button class="btn btn-sm btn-danger mx-1" type="button" wire:click="confirm('delete', {{ $crmCustomer->id }})" wire:loading.attr="disabled">
                                        {{ trans('global.delete') }}
                                    </button>
                                @endcan
                            </div>
