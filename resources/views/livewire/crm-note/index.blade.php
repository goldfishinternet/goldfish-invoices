                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex justify-content-end">
                                    @can('crm_note_show')
                                        <a class="btn btn-sm btn-info mx-1" href="{{ route('admin.crm-notes.show', $crmNote) }}">
                                            {{ trans('global.view') }}
                                        </a>
                                    @endcan
                                    @can('crm_note_edit')
                                        <a class="btn btn-sm btn-primary mx-1" href="{{ route('admin.crm-notes.edit', $crmNote) }}">
                                            {{ trans('global.edit') }}
                                        </a>
                                    @endcan
                                    @can('crm_note_delete')
                                        <button class="btn btn-sm btn-danger mx-1" type="button" wire:click="confirm('delete', {{ $crmNote->id }})" wire:loading.attr="disabled">
                                            {{ trans('global.delete') }}
                                        </button>
                                    @endcan
                                </div>
