    ...
    <div class="card-controls sm:flex">
        <div class="w-full sm:w-1/2">
            ...
            @if(file_exists(app_path('Http/Livewire/ExcelExport.php')))
                <livewire:excel-export model="ContactContact" format="csv" />
                <livewire:excel-export model="ContactContact" format="xlsx" />
                <livewire:excel-export model="ContactContact" format="pdf" />
            @endif
