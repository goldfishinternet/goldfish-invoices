                ...
                <div class="card-body">
                    <div class="flex flex-col pt-3">
                        @foreach($conversation->messages as $message)
                            <div class="mb-1">
                                <div class="{{ (int) $message->user_id === (int) auth()->id() ? 'bg-indigo-100 divide-indigo-300 ml-6' : 'bg-blueGray-100 divide-blueGray-300' }} inline-block px-4 py-3 rounded divide-y divide-solid">
